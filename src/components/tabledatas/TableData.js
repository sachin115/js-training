    ...
    return (
        <div>
            <input
                ...
                style={{marginTop:"2vh"}}
            />
            <button variant="contained" style={{marginLeft:"2vh", color:"#ffffff", backgroundColor: "#6a1b9a"}} onClick={SearchData}>search</button>
                    ...
                    {users.map(({ id, username, email, phone, website }) => {
                        return (
                            <tr key={id}>
                                ...
                                <td>{phone}</td>
                                <td>{website}</td>
                                <td><button onClick={() => DeleteData(id)} style={{color:"#ffffff", backgroundColor: "#6a1b9a"}}>DELETE</button></td>
                                <td><Link to={`/posts/${id}`}>posts</Link></td>
                            </tr>
                        )
                    }
                    )}
